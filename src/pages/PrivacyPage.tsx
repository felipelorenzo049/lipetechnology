      ...
      <section className="pt-32 pb-24 md:pt-40 md:pb-32">
        <div className="container mx-auto px-6 max-w-3xl">
          ...
          <div className="prose prose-invert prose-sm max-w-none font-body space-y-6 text-foreground/80">
            {(t("privacy.sections", { returnObjects: true }) as Array<{ heading: string; content: string }>).map((s, i) => (
              <div key={i}>
          ...
          <p className="text-muted-foreground text-xs font-body mt-12">{t("privacy.lastUpdated")}</p>
        </div>
      </section>
      <Footer />
    </GradientBackground>
