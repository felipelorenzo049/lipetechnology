...
// --- Inline SVG Logos ---
const ReactLogo = () => (
  <svg viewBox="0 0 256 228" className="size-8" fill="none">
    ...
    <circle cx="128" cy="113.634" r="23.844" fill="currentColor"/>
  </svg>
);

const NextJSLogo = () => (
  <svg viewBox="0 0 180 180" className="size-8" fill="none">
...
const TypeScriptLogo = () => (
  <svg viewBox="0 0 256 256" className="size-8" fill="none">
...
const SupabaseLogo = () => (
  <svg viewBox="0 0 109 113" className="size-8" fill="none">
...
const NodeJSLogo = () => (
  <svg viewBox="0 0 256 289" className="size-8" fill="none">
...
const TailwindLogo = () => (
  <svg viewBox="0 0 256 154" className="size-8" fill="none">
...
const FigmaLogo = () => (
  <svg viewBox="0 0 256 384" className="size-8" fill="none">
...
// LIPE logo for center
const LipeLogo = () => (
  <svg viewBox="0 0 100 100" className="size-10" fill="none">
    <text x="50" y="58" textAnchor="middle" dominantBaseline="middle" fill="hsl(var(--primary))" fontSize="24" fontWeight="bold" fontFamily="monospace">LIPE</text>
  </svg>
);
